...
function print2ps() {
	 ...
	 gPrintSettings.toFileName = dest;
 	 if (pdf == "true") { gPrintSettings.OutputFormat = 3; }
...
var tmp_pdf =  nsCommandLine.handleFlagWithParam("pdf", false);
if(tmp_pdf== "true" || tmp_pdf == "false") {
  pdf = (tmp_pdf == "true") ? true : false;
}
